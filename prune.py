...
# heechul
def new_cfg(model, ckpt):
    donntprune = []
    print(model.yaml)
#    for k,m in enumerate(model.model.modules()):
#        print(m)
...
#    print(cfg_mask)
    ...
    newmodel = Model_prune(opt.cfg or ckpt['model'].yaml, ch=3, channel=cfg).to(device)  # create
    print(newmodel)
